        ...
        while True:
            ...
            for new_node in get_new_nodes(node, self.size):
                ...
                if new_str not in nodes:
                    ...
                    # for idx, open_node in enumerate(open_nodes):
                    #     if new_node[4] < open_node[4]:
                    #         open_nodes.insert(idx, new_node)
                    #         break
                    # else:
                    #     open_nodes.append(new_node)
...
#     if node[0] is None:
#         return []
#     return get_path(node[0]) + [(node[3][0][0], node[3][1])]
...
#                     yield (parent, new_grid, new_cars, (new_cars[idx], 'a'), cost + get_cost(parent[3][0], cars[idx]))
...
#                     new_cars = (*cars[:idx] , (letter, x+1, y, orientation, length) , *cars[idx+1:]) # copy the cars with the change
#                     yield (parent, new_grid, new_cars, (new_cars[idx], 'd'), cost+ get_cost(parent[3][0], cars[idx]))
...
#                     yield (parent, new_grid, new_cars, (new_cars[idx], 'w'), cost+ get_cost(parent[3][0], cars[idx]))
...
#                     new_cars = (*cars[:idx] , (letter, x, y+1, orientation, length) , *cars[idx+1:]) # copy the cars with the change
#                     yield (parent, new_grid, new_cars, (new_cars[idx], 's'), cost+ get_cost(parent[3][0], cars[idx]))


# def heuristic():
#     ...

# def get_cost(car1,car2):
#     # return 1
#     if car1 is None:
#         return 2 + abs(car2[1] - 3) + abs(car2[2] - 3)
#     if car1[0] == car2[0]:
#         return 1
#     return 2 + abs(car1[1] - car2[1]) + abs(car1[2] - car2[2])
